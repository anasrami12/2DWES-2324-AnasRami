...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $nombre=str_pad($nombre,strlen($nombre)+2,"#",STR_PAD_RIGHT);
        $apellido1=str_pad($apellido1,strlen($apellido1)+2,"#",STR_PAD_RIGHT);
        $apellido2=str_pad($apellido2,strlen($apellido2)+2,"#",STR_PAD_RIGHT);
        $fecha=str_pad($fecha,strlen($fecha)+2,"#",STR_PAD_RIGHT);
